...
print(f"The total sum of the loans is {total_value_of_loans}")
...
print(f"The avg. of the loans is {average_loan_amount}")
...
present_value = new_loan.get("loan_price")

print(f"The present value of the loan is: {present_value}")


annual_discount_rate = 0.2
new_loan_value = present_value * annual_discount_rate
